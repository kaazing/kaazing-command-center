 ...
 *
 * @module nic-write-thpt-indiv-chart
 */
YUI.add('nic-write-thpt-indiv-chart', function(Y) {
    ...
    var Lang = Y.Lang,
    NAME = 'nicWriteThptIndivChart';

    /**
     * The View for the 'nic write throughput (bps) for each NIC 
     * on each host for each gateway' chart
     *
     * @class NicWriteThptIndivChart
     * @extends Y.DashboardChart
     * @uses xxxxx
     * @constructor
     * @cfg {object} configuration attributes
     */
    Y.NicWriteThptIndivChart = Y.Base.create(
        NAME, 
        Y.DashboardChart, 
        [], 
        {
            ...
            onNicListUpdate: function(ev) {
                ...
                for (var nicIndex = 0; nicIndex < numNics; nicIndex++) {
                    newValue = nicData[nicIndex][txBytesPerSecondIndex];
